...
class TransactionRoutesTest {
    ...
    @Test
    fun `POST transactions creates record`() =
        testApplication {
            ...
            assertTrue(body.contains("600519"))
        }
    ...
    @Test
    fun `GET transactions without token returns 401`() =
        testApplication {
            application { testModule() }
    ...
    @Test
    fun `DELETE transactions removes record`() =
        testApplication {
            application { testModule() }
